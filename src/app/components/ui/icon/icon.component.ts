...
@Component({
  ...
  template: `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
      ...
      <circle *ngFor="let circle of svg.circles" [attr.cx]="circle.cy" [attr.cy]="circle.cy" [attr.r]="circle.r"/>
    </svg>
  `,
})
export class IconComponent implements OnInit {
  ...
  ngOnInit() {
    if (this.iconName) {
      ...
      console.error('In order to show an icon its name most be provided. `iconName: IconNameEnum`');
    }
  }
}
